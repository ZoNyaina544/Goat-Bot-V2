...
const doNotDelete = "[ 🌲 |  𝗖𝗛𝗜𝗦𝗨 𝗛𝗔𝗬𝗔𝗦𝗘  ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy

module.exports = {
  config: {
    name: "help",
    version: "1.17",
    author: "kazu.kinoshitaXtsiaro", // original author Kshitiz 
    countDown: 5,
    role: 0,
    shortDescription: {
